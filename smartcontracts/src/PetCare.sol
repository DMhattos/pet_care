...
contract PetCare {    
    ...
    // Funcao para adicionar um novo pet
    function addPet(string memory _name, string memory _breed, uint8 _age) public {
        ...
        petIdCounter++; // Incrementa o contador para garantir um ID unico para o proximo pet
    }

    // Funcao para adicionar uma vacina a um pet especifico
    ...
    // Funcao para obter os detalhes de uma vacina especifica de um pet
    ...
    // Funcao para obter informacoes de um pet especifico
